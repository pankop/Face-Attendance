...
cap = cv2.VideoCapture(0)  # coba 0 dulu
cap.set(3, 640)
cap.set(4, 480)
    ...
    if faceCurFrame:
        ...
        if counter !=0:
            ...
            if modeType != 3:
                ...
                imgBackground[44:44 + 633, 808:808 + 414] = imgModeList[modeType]
                # ⏸️ Tahan tampilan selama 2 detik
                for _ in range(10):  # 20 x 100 ms = 2000 ms
                    # cv2.imshow("Face Attendance", imgBackground)
                    cv2.waitKey(100)
